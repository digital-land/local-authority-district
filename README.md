# Local Authority District pages
...
These pages are [updated nightly](https://github.com/digital-land/local-authority-district/actions) by the [GitHub Action](.github/workflows/run.yml).
